 ...
 */
@Stateful
@Remote(MemberListProducerService.class)
public class MemberListProducer implements MemberListProducerService, Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -6281379775907151112L;
