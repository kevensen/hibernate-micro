...
@Stateless
@Remote(MemberRegistrationService.class)
public class MemberRegistration implements MemberRegistrationService, Serializable{

    /**
	 * 
	 */
	private static final long serialVersionUID = -7729592607876840755L;
